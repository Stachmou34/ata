(function ( $, x5engine ) {
	...
	s.siteId = 'E7158431A3B1D6F94AFD52AEDFD67D53';
	...
	b.push(function() { x.cookielaw.showBanner({id: "cookie-law-message",texts: [
		{ basepath: "", text: "<div>Ce site utilise des cookies, veuillez lire la note d'information sur le <a href=\"mentions-legales.html\" onmouseover=\"x5engine.imTip.Show(this, { text: 'Informations légales et Conditions d\\'utilisation des données.', width: 180});\" onfocus=\"$(this).trigger('mouseover');\"  class=\"imCssLink\" onclick=\"return x5engine.utils.location('mentions-legales.html', null, false)\">Traitement des Données</a>.</div>" },
		{ basepath: "../", text: "<div>Ce site utilise des cookies, veuillez lire la note d'information sur le <a href=\"../mentions-legales.html\" onmouseover=\"x5engine.imTip.Show(this, { text: 'Informations légales et Conditions d\\'utilisation des données.', width: 180});\" onfocus=\"$(this).trigger('mouseover');\"  class=\"imCssLink\" onclick=\"return x5engine.utils.location('../mentions-legales.html', null, false)\">Traitement des Données</a>.</div>" }
	],
